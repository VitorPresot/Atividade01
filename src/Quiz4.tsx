...
export default function Quiz4() {
  ...
  const question = "Em qual ano foi criado o JavaScript?";
  
  const options = [
    { id: '1', text: '1990', correct: false },
    { id: '2', text: '1995', correct: true },
    { id: '3', text: '2000', correct: false },
    { id: '4', text: '2005', correct: false },
  ];
  ...
  const checkAnswer = () => {
    ...
    router.push({ pathname: '/Quiz5', params: { pontos: newPoints } });
  };
      ...
      <View style={[styles.container, { paddingTop: 30, paddingBottom: 30 }]}>
        <View style={styles.hudContainer}>
          <View style={styles.hudItem}>
            ...
            <Text style={styles.hudValue}>4/10</Text>
          </View>
          <View style={styles.hudItem}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionNumber}>⚔️ DESAFIO 4</Text>

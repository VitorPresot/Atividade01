...
export default function Quiz5() {
  ...
  const question = "Qual é a função de um estado em React?";
  
  const options = [
    { id: '1', text: 'Armazenar dados que mudam com o tempo', correct: true },
    { id: '2', text: 'Apenas decorar a interface', correct: false },
    { id: '3', text: 'Conectar ao banco de dados', correct: false },
    { id: '4', text: 'Compilar o código', correct: false },
  ];
  ...
  const checkAnswer = () => {
    ...
    router.push({ pathname: '/Quiz6', params: { pontos: newPoints } });
  };

  const progressPercent = (5 / 10) * 100;
      ...
      <View style={[styles.container, { paddingTop: 30, paddingBottom: 30 }]}>
        <View style={styles.hudContainer}>
          <View style={styles.hudItem}>
            ...
            <Text style={styles.hudValue}>5/10</Text>
          </View>
          <View style={styles.hudItem}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionNumber}>⚔️ DESAFIO 5</Text>

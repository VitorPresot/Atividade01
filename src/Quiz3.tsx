...
export default function Quiz3() {
  ...
  const question = "Qual linguagem você está usando neste projeto?";
  
  const options = [
    { id: '1', text: 'Python', correct: false },
    { id: '2', text: 'TypeScript', correct: true },
  ...
  const checkAnswer = () => {
    ...
    router.push({ pathname: '/Quiz4', params: { pontos: newPoints } });
  };

  const progressPercent = (3 / 10) * 100;
      ...
      <View style={[styles.container, { paddingTop: 30, paddingBottom: 30 }]}>
        ...
        <View style={styles.hudContainer}>
          <View style={styles.hudItem}>
            ...
            <Text style={styles.hudValue}>3/10</Text>
          </View>
          <View style={styles.hudItem}>
        ...
        <View style={styles.questionContainer}>
          <Text style={styles.questionNumber}>⚔️ DESAFIO 3</Text>
